    ...
    <section className="bg-gray-50 py-16">
      <div className="container mx-auto px-4 md:px-8" data-aos="fade-up">
        ...
        <div className="text-center mb-12">
          <h2 className="text-3xl md:text-4xl font-bold mb-4 text-green-500">Get Involved</h2>
        ...
        <div className="flex flex-col md:flex-row justify-center items-center gap-6">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            ...
            <button className="px-6 py-3 bg-white text-green-500 border border-green-500 rounded-lg shadow-md hover:bg-green-500 hover:text-white transition">
              Become a Volunteer
            </button>
          </div>
        </div>
